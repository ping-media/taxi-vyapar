...
public class send_review2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send_review2);
        ...
        FirebaseFirestore.getInstance().collection("header").document("header")
                .collection("agent").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    @Override
                ...
                FirebaseFirestore.getInstance().collection("reviews").document(fladid).set(user)
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                FirebaseFirestore.getInstance().collection("users")
                                        ...
                                        .get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                                            ...
                                            public void onSuccess(QuerySnapshot querySnapshot) {
                                                ...
                                                requestreview.put("request", "accept");
                                                requestreview.put("SenderMobileNo", custno);
                                                requestreview.put("SenderName", custname);
                                                requestreview.put("BookingId", str_bkid);
                                                requestreview.put("TransactionId", transId);
                                                requestreview.put("TimeStamp", timestmp);

                                                FirebaseFirestore.getInstance().collection("users")
                                                        .document(profileContainer.userMobileNo).collection("reviewRequest")
                                                        .document(str_bkid)
                                                        .set(requestreview);
                                                ...
                                                try {
                                                    ...
                                                    FcmNotificationsSender notificationsSender = new FcmNotificationsSender(body,
                                                            getApplicationContext(), send_review2.this);
                                                    notificationsSender.SendNotifications();
                                                } catch (Exception e) {
                                                    Toast.makeText(getApplicationContext(), e.toString(), Toast.LENGTH_SHORT).show();
                                                }
                                                Toast.makeText(send_review2.this, "Review submitted.", Toast.LENGTH_SHORT).show();
                            ...
                            public void onFailure(@NonNull Exception e) {
                                load.dismiss();
                                Toast.makeText(send_review2.this, "Your internet is not working.", Toast.LENGTH_SHORT).show();
                            }
                        });
