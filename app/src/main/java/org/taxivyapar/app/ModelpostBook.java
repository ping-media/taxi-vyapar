...
public class ModelpostBook implements Comparable<ModelpostBook> {
    ...
    public ModelpostBook() {
    }

    public ModelpostBook(String vehicleName, String startDate, String startTime, String startTimeStamp, String remark,
                         ...
                         String bookingType, String bookingId, String addressCity, String dropAddressCity, String extra,
                         String bookingPlatform, String preferenceContact, String preferenceDriver, double radiusInM) {
    ...
    @Override
    public int compareTo(ModelpostBook otherModelpost) {
        return Double.compare(this.radiusInM, otherModelpost.getRadiusInM());
    }
